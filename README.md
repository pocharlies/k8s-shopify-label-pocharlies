...
Labels stack completo: routing-service, saga-launcher, label-storage, event-gateway, ups-adapter, shopify-app, synapse (operator/api/correlator) + Redis propio + NATS. DB: shared postgres
